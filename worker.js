var authConfig = {
  ...
  accent_color: 'red', // red | pink | purple | deep-purple | indigo | blue | light-blue | cyan | teal | green | light-green | lime | yellow | amber | orange | deep-orange
...
<head>
  ...
  <script src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/kry9ton/goindex-drive@${authConfig.version}/themes/${authConfig.theme}/app.js"></script>
...
/**
  ...
  basicAuthResponse(request) {
    const user = this.root.user || '',
      pass = this.root.pass || '',
      _401 = new Response('I think you no must be here, Go away now!!.', {
